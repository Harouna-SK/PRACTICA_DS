...
public class DirectoryAreas {
    ...
    // 2. Atributos de instancia (YA NO SON STATIC)
    private Area rootArea;
    private ArrayList<Door> allDoors;
    // Inicializamos el logger para evitar errores
    ...
    // 4. Método de acceso público (Singleton)
    ...
    // 5. Métodos de lógica (YA NO SON STATIC)
    ...
    public Area findAreaById(String id) {
        ...
        // Mantengo tu lógica de Visitor que ya tenías implementada
